      ...
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center space-x-8">
          ...
          <nav className="hidden md:flex space-x-6">
            ...
            {isAuthenticated && (
              <>
                <Link to="/dashboard" className="text-foreground mt-1 hover:text-insurance-primary transition-colors">
                  My Policies
                </Link>
                <Link to="/support" className="text-foreground mt-1 hover:text-insurance-primary transition-colors">
                  Support
                </Link>
                <Link to="/blogs" className="text-foreground mt-1 hover:text-insurance-primary transition-colors">
                  Blogs
                </Link>
              </>
            )}
