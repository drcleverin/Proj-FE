...
import { Eye, Search, Filter, MoreHorizontal, Loader2 } from "lucide-react";
...
export default function AdminClaims() {
    ...
    const mapToAdminClaimItem = (aggregatedClaim: AggregatedClaimDetails): AdminClaimItem => {
        ...
        const policySumInsured = aggregatedClaim.sumInsured || 100000; // Use policy's sumInsured from backend
