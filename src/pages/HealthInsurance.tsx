// src/components/HealthInsurance.tsx
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Example usage of HealthReviewStep with selected plan id or index */}
        {/* 
        {selectedPlan && (
          <HealthReviewStep
            planId={selectedPlan}
            planIndex={healthPlans.findIndex(plan => plan.id === selectedPlan)}
          />
        )}
        */}
