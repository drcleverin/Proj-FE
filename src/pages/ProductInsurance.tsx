// src/pages/ProductInsurance.tsx
import { useState } from "react";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"// Ensure these paths are correct relative to THIS file
import { Button } from "@/components/ui/button"; // Assuming "@/components/ui/button" resolves correctly
import { Input } from "@/components/ui/input";   // Assuming "@/components/ui/input" resolves correctly
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select"; // Assuming these resolve correctly
import Header from "@/components/Header"; // Assuming "@/components/Header" resolves correctly
import { Smartphone, Laptop, Home, Camera } from "lucide-react"; // Make sure lucide-react is installed
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Process - CORRECTED SECTION */}
        {/* This Card and CardContent now correctly wrap the "Simple Claim Process" div */}
        <Card className="bg-white rounded-lg p-8 mt-12">
          <CardContent>
    ...
    </div> // Closes the overall "min-h-screen" div
  );
};
